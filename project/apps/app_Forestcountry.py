...
class MyForestCountryApp(HydraHeadApp):
...
#wrap all your code in this method and you should be done
    def run(self):
        ...
        cursor=db.cursor()
        sql = sql = "select b.country,a.years,a.cumulative_co2_emissions from forest_by_country a, country b where a.country_code=b.country_code"
        cursor.execute(sql)
        res = cursor.fetchall()
        ...
        subtitle = '<p style="font-family:sans-serif; font-size: 20px;color:#008080;">Forest Land(Country)</p>'
        st.markdown(subtitle, unsafe_allow_html=True)


        countries = st.multiselect("Choose countries to visualize forest land percentage",all_country , all_country[-16:-13])
